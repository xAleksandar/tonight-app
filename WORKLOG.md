...
## Next Up
1. Task 5: Implement user profile functionality (PATCH /api/users/me, profile page/components, related property tests).
2. Task 6: Implement geospatial service (find nearby events + property tests).
