...
- 2026-02-10 17:10 runner: Routed the People page's Messages affordances through the shared Messages modal (desktop header/sidebar, grid contact CTAs, and the mobile action bar), kept the unread badges in sync, and made the nav state follow the modal so Discover/People/Message highlights stay accurate across breakpoints; `npm test` (68 suites) passes.
